                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink
                               href={route("posada.get")}
                            >Catalogo Posada</ResponsiveNavLink>
                            <ResponsiveNavLink  href={route("precio.get")}>
                                   Catalogo de Precio Base
                            </ResponsiveNavLink>
                            <ResponsiveNavLink  href={route("huespede.get")}>
                                   Catalogo de Huespede
                            </ResponsiveNavLink>
